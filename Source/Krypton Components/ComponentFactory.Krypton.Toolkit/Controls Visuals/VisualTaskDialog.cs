...
// 
//  Modifications by Saleyn, Peter Wagner(aka Wagnerp) & Simon Coghlan(aka Smurf-IV) 2017 - 2019. All rights reserved. (https://github.com/Wagnerp/Krypton-NET-5.452)
    ...
    public class VisualTaskDialog : KryptonForm
    {
        ...
        private void UpdateRadioButtons()
        {
            ...
            else
            {
                ...
                maxButtonSize.Width = Math.Min(Math.Max(maxButtonSize.Width, 150), 452);
        ...
        private Size UpdateMainTextSizing()
        {
            ...
            {
                // Find size of the labels when it has a maximum length of 452
                _messageText.UpdateFont();
                _messageContent.UpdateFont();
                _messageContentMultiline.Font = _messageContent.Font;
                Size messageMainSize = g.MeasureString(_mainInstruction, _messageText.Font, 452).ToSize();
                messageContentSize = g.MeasureString(_content, _messageContent.Font, 452).ToSize();
