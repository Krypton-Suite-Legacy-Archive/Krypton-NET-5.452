...
// 
//  Modifications by Megakraken & Simon Coghlan(aka Smurf-IV) 2017 - 2019. All rights reserved. (https://github.com/Wagnerp/Krypton-NET-5.452)
...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    public class KryptonByteViewer : TableLayoutPanel
    {
        ...
        private const int HEX_WIDTH = 452;
